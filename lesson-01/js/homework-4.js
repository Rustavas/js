...
// console.log(pizzaPalace.order('Cheese', makePizza, onOrderError));
...
//     if(element > value){
//       console.log(filteredNumbers.push(element)); 
//     };
//   });
...
// }
// console.log(filterArray([12, 34,56,78], 25));
...
//   const commonElements = [];
  ...
  // firstArray.forEach(function callback1(element1, index1, array1){
  //   secondArray.forEach(function callback2(element2, index2, array2){
  //     if(element1 === element2){
  //       console.log(commonElements.push(element1)); 
  //     };
  //   });
  // });
...
// 18/48
// Change code below this line
// const getUserEmails = users => users.map(user => {
//   return user.email
...
// ];
// Change code below this line
// const getUsersWithAge = (users, minAge, maxAge) => users.filter(user => {
//   return user.age >= minAge && user.age <= maxAge
 

// });
// console.log(getUsersWithAge(users, 25, 43)); 
...
// ]
// // Change code below this line
// const getFriends = (users) => users.flatMap(user => user.friends).filter((elem, idx, arr) => {
...
// // Change code below this line
// const totalPlayTime = playtimes.reduce((playtime, value) => {return playtime + value}, 0);
...
// ];
// Change code below this line
// const averagePlaytimePlayer = players.map(player => player.playtime / player.gamesPlayed);
// console.log(averagePlaytimePlayer);
// const totalAveragePlaytimePerGame = averagePlaytimePlayer.reduce((values, element) => { return values + element;}, 0);
...
//   (allBalance, user) => {return allBalance + user.balance}, 0) 
...
// ]
// Change code below this line
// const getTotalFriendCount = users.flatMap(user => user.friends).length;
// console.log(getTotalFriendCount)

// const getTotalFriendCount =  users.reduce(
//   (accFriends, user) => 
//      accFriends + user.friends.length  
//   , 0);
// console.log(getTotalFriendCount);
...
// const sortedByAuthorName = [...books].sort((xBook, yBook) => xBook.author.localeCompare(yBook.author));
// const sortedByReversedAuthorName = [...books].sort((xBook, yBook) => yBook.author.localeCompare(xBook.author));
// const sortedByAscendingRating = [...books].sort((xBook, yBook) => xBook.rating - yBook.rating);
// const sortedByDescentingRating = [...books].sort((xBook, yBook) => yBook.rating - xBook.rating);
...
//   (user1, user2) => user1.balance - user2.balance);
// Change code above this line
...
// ]
// Change code below this line
// const sortByDescendingFriendCount = [...users].sort(
...
// ]
// // Change code below this line
// const sortByName = [...users].sort((user1, user2) => 
...
// sort((book1, book2) => book1.localeCompare(book2));
...
// ]
// Change code below this line
// const getNamesSortedByFriendCount = [...users].sort((user1, user2) => 
...
//  пол которых (свойство gender) совпадает со значением 
//  параметра gender.
console.log('first');